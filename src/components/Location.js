/* 
  This component shows where the PingPong Club is located.
  It uses a Google Maps embed to display the club's physical location.
  Visitors can see the address and get directions to the club.
  The map is interactive, allowing users to zoom and pan.
*/
...
const Location = () => {
  return (
    <section id="external-widget" className="container bento-section">
      <SectionTitle 
        title="Our Location" 
